...
const ConfirmTransfer = ({ route, navigation }) => {
  ...
  const handleVerify = () => {
    if (!isPinComplete) {
      Alert.alert('Incomplete PIN', `Please enter ${PIN_LENGTH} digits to continue.`);
      return;
    }
      ...
      >
        ...
        >
          <View style={styles.modalContent}>
            ...
            <Image source={require('../assets/ahsar.png')} style={styles.asharimage} />
          </View>
          ...
          <View style={styles.keyboardContainer}>
            ...
            <View style={[styles.row, { justifyContent: 'space-between' }]}>
              ...
              <TouchableOpacity
                style={[
                  styles.key,
                  isPinComplete ? { backgroundColor: Colors.primary } : { backgroundColor: '#ccc' },
                ]}
...
const styles = StyleSheet.create({
  ...
  headerText: { textAlign: 'center', marginVertical: 10, fontSize: 20, fontWeight: '600' },
  amountText: { textAlign: 'center', marginVertical: 8, fontSize: 25, fontWeight: 'bold', color: Colors.primary },
  ...
  transactionBox: { backgroundColor: '#F0F0F0', marginTop: 10, marginBottom: 15, borderRadius: 10, padding: 12 },
  content: { flexDirection: 'row', justifyContent: 'space-between', marginVertical: 10 },
  firstText: { fontSize: 14, color: '#444' },
  secondText: { fontSize: 16, fontWeight: '600', color: '#000' },
  totalText: { fontSize: 14, fontWeight: 'bold', color: '#474747ff' },
  label: { fontSize: 16, fontWeight: '600', marginBottom: 5, color: Colors.third },
  reasonBox: { backgroundColor: '#F0F0F0', padding: 15, borderRadius: 12, fontSize: 16, color: 'black', marginBottom: 20 },
  confirmButton: { backgroundColor: Colors.primary, padding: 15, borderRadius: 30, alignItems: 'center', marginTop: 10 },
  ...
  modalContent: { backgroundColor: 'white', padding: 20, borderTopLeftRadius: 20, borderTopRightRadius: 20, paddingBottom: 30 },
