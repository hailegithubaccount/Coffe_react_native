...
const ConfirmTransfer = ({ route, navigation }) => {
  const { reason, amount, accountNumber, recipientName, isBudgetEnabled } =
    route.params || {};
  ...
  const handleBackspace = () => {
    ...
    if (lastFilled !== -1) newPin[lastFilled] = '';
    setPin(newPin);
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        ...
        <Text style={styles.amountText}>{amount}.00 ETB</Text>
            ...
            <View style={[styles.row, { justifyContent: 'space-between' }]}>
              ...
              >
                <Image
                  ...
                  style={{
                    width: '30%', // or '70%' depending on your preference
                    height: '30%',
                    resizeMode: 'contain',
                  }}
                />
